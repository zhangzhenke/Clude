...
<nav class="ui inverted  segment m-padded-tb-mini m-shadow-smail" >
    ...
    <div class="ui container">
        <div class="ui  inverted secondary stackable menu">
            <h2 class="ui teal header item">垃圾回收站，让每一次删除都没有遗憾！</h2>
...
<c:if test="${message!=null}">
    <div class="ui success  message" unless="${strings.isEmpty(message)}" style="width: 300px;height: 50px;margin-left: 85%">
...
<form action="${pageContext.request.contextPath}/searchFile" method="post" style="margin-left:30%;margin-top: 50px !important;width: 500px !important;">
                ...
                <tr class="table-info">
                    ...
                    <td>
                        <a class="ui mini teal button"
                           href="${pageContext.request.contextPath}/huifu?id=${c.id }">恢复</a>
                    </td>
                    <td>
...
<div style="margin-left: 45%">
    <p class="text-secondary" style="color: white;font-size: 15px">
        ...
        每页 <input type="text" id="pagesize" value="${pagebean.pagesize }" onchange="gotopage(${pagebean.currentpage})"
                  style="font-size: 15px" maxlength="5">条
    ...
    <input type="text" style="color: black;font-size: 10px" maxlength="5" id="pagenum">页
</div>
...
<script type="text/javascript">
    ...
    function gotopage(currentpage) {
        ...
        window.location.href = '${pageContext.request.contextPath}/garbage?currentpage=' + currentpage + '&pagesize=' + pagesize;
