...
//
	...
	public  List<File> getUserFilesofgarbage(Page page) throws Exception {
		return dao.getUserFilesofgarbage(page);
	}
	//
	public  int countUserFilesofgarbage(String username) throws Exception {
		return dao.countUserFilesofgarbage(username);
...
//
	...
	public  int findFilesharenums(String filename){

		return dao.findFileByFilename(filename);
	}

	public  int updateFilegarbage(Boolean garbage,int id,String filename) throws Exception {
	   dao.updateFilegarbage(garbage,filename,id);
	   return 1;
	}
